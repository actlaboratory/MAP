...
class Dialog(BaseDialog):
	...
	def InstallControls(self):
		...
		self.auto_start = creator.checkbox(_("サーバを起動して最小化状態で起動する(&S)"))
		creator.GetSizer().SetItemSpan(self.auto_start.GetParent(),2)
	...
	def load(self):
		...
		self._setValue(self.auto_start,"general", "auto_start_server", configType.BOOL)
